        ...
        <div class="col-sm-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form id="myform" class="form-horizontal" method="post" action="<?php echo base_url();?>admin/c_directional/delete_directional" >

                        <h4 align="center">你确定要删除<?php echo $orgnum."/".$filename;?>文件吗？</h4>
                        ...
                        <div class="form-group">
                            <div class="modal-footer" style="border-top: 0!important; margin-right: 90px;">
                                ...
                                <a href="" class="closeWindows btn btn-danger">放弃</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
