    ...
    <div class="tab-body" style="width: 95%;">
        ...
        <div class="tab-panel active" id="tab-set" style="">
            ...
            <form method="post" class="form-x" method="post" target="_parent">
                ...
                <div class="form-group">
                    <div class="label">
                        <label for="rolename">车牌号码：</label>
                    </div>
                    <div class="field">
                        <input type="text" class="input"  value="<?php echo $hphm?>" id="hphm">
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                        <label for="rolename">车架号：</label>
                    </div>
                    <div class="field">
                        <input type="text" class="input"  value="<?php echo $cjh?>" id="cjh">
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                        <label for="rolename">品牌型号：</label>
                    </div>
                    <div class="field">
                        <input type="text" class="input"  value="<?php echo $ppxh?>" id="ppxh">
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
...
<script>
    $('.operate_sub').click(function(){
        var id = $('#id').val();
        var hphm = $('#hphm').val();    //辖区道路名称
        var cjh = $('#cjh').val();    //隐患路段
        var ppxh = $('#ppxh').val();   //事故多发路段
        ...
        if(sjhm.length != 11){
            ...
            $.ajax({
                url:'<?php echo base_url();?>admin/c_non_vehicle/edit_up',
                type:'post',
                data:{
                    'id':id,
                    'hphm': hphm,
