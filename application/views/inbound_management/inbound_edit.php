...
<div class="tab" style="">
    ...
    <input type="hidden" value="<?php echo $datas[0]['xh']; ?>" id="h_xh">
        ...
        <div class="tab-panel active" id="tab-set" style="">
            ...
            <form method="post" class="form-x" method="post" target="_parent">
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input" value="<?php echo $datas[0]['hphm']; ?>" id="hphm">
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                    ...
                    <div class="field">
                        <select class="input" id="hpzl">
                            ...
                            <?php foreach ($data1 as $v) { ?>
                                <option value="<?php echo $v['DMZ']; ?>" <?php if ($v['DMZ'] == $datas[0]['hpzl']) {
                                    echo "selected";
                                } ?> ><?php echo $v['DMSM1']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input" value="<?php echo $datas[0]['sfzmhm']; ?>" id="sfzmhm">
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                    ...
                    <div class="field">
                        <input type="text" class="input" id="inbound_time" name="inbound_time"
                               value="<?php echo date('Y-m-d H:i', $datas[0]['czsj']); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                    ...
                    <div class="field">
                        <input type="text" class="input" value="<?php echo $datas[0]['czjg']; ?>" id="czjg">
                    </div>
                </div>
                    ...
                    <div class="field">
                        <select class="input" id="tccmc">
                            ...
                            <?php foreach ($parking as $v) { ?>
                                <option value="<?php echo $v['id']; ?>" <?php if ($v['id'] == $datas[0]['tccmc']) {
                                    echo 'selected';
                                } ?>><?php echo $v['task_name']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="field">
                        <select class="input" id="tccdz">
                            <?php foreach ($parking_dz as $v) { ?>
                                <option value="<?php echo $v['id']; ?>" <?php if ($v['id'] == $datas[0]['tccdz']) {
                                    echo 'selected';
                                } ?>><?php echo $v['parking_dizhi']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                            ...
                            <?php if ($pic_arr[0]): ?>
                                <?php foreach ($pic_arr as $value): ?>
                                    <div style='width: 98px;float:left;height: 98px;'>
                                        <img class='img_class' id="<?php echo $value; ?>"
                    ...
                    <div class="field">
                        <table class="table table-bordered table-hover" style="width: 90%;">
                            ...
                            <?php foreach ($data as $value): ?>
                                <tr class="tr_class">
                                    <td>
                                        <input class="assign_checkbox" <?php if ($value['accounts'] == $datas[0]['jybh']) {
                                            echo "checked";
...
<script type="text/javascript">
    ...
    $("#sub").click(function () {
        ...
        $.ajax({
            url: URL + 'admin/c_inbound_management/inbound_edit_pro',
            type: 'post',
            data: {
                'xh': xh,
                'hphm': hphm,
