            ...
            <div>
                <div>
                    <div style="width:1760px; overflow: auto;">
                        <form method="post" action="<?php echo base_url() ?>admin/c_inbound_management/search">
                            <div class="filed input-group">
                                <div>
                                    ...
                                    <span>号牌号码：</span><input type="text" id="hphm" name="hphm" style="width: 200px"
                                                             value="<?php echo $hphms; ?>"> &nbsp;&nbsp;
                                    ...
                                    <span>身份证码：</span><input type="text" id="sfzmhm" name="sfzmhm"
                                                             style="width: 200px;margin-bottom: 10px"
                                                             value="<?php echo $sfzmhms; ?>"> &nbsp;&nbsp;
                                    <br>
                                    <span>处置民警：</span><input type="text" id="czr" name="czr"
                                                             style="width: 195px;margin-left: 5px"
                                                             value="<?php echo $czrs; ?>"> &nbsp;&nbsp;

                                    <span>开始时间：</span><input type="text" id="startTime" name="startTime"
                                                             style="width: 200px" <?php if ($startTime): ?> value="<?php echo date('Y-m-d H:i', $startTime); ?>" <?php endif; ?> >
                                    &nbsp;&nbsp;

                                    <span>结束时间：</span><input type="text" id="endTime" name="endTime"
                                                             style="width: 195px;margin-left: 5px" <?php if ($endTime): ?>  value="<?php echo date('Y-m-d H:i', $endTime); ?>" <?php endif; ?> >
                                    &nbsp;&nbsp;
                                    <button type="submit" class="button button-small border border-yellow operate_sub"
                                            style="margin-left: 200px" id="search">搜索
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="right_button x11-move" style="margin-top:0px; ">
                        <a href="#" class="button button-small border border-green add">入库</a>
                    </div>
                </div>
                    ...
                    <div class="ibox-content">
                        <table class="table table-bordered table-hover">
                            ...
                            <?php foreach ($data as $value): ?>
                                <tr style="background-color: <?php if ($value['sfyj'] == 1) {
                                    echo 'red';
                                } ?>" id="<?php echo $value['xh']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" hfht="<?php echo $value['xh']; ?>"
                                           class="edit button button-small border border-blue operate_sub">编辑</a>
                                        <a href="#" hfht="<?php echo $value['xh']; ?>"
                                           class="delete button button-small border border-gray operate_sub">删除</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                        ...
                        <ul>
                            <?php if ($type == '1'): ?><?php echo $this->pagination->create_links(); ?><?php endif; ?>
                            <span class="total" id='link'>共 <?php echo $total; ?> 条</span>
                        </ul>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $(".delete").click(function () {
        ...
        layer.confirm('确定删除该入库信息？', {
            ...
            $.post('<?php echo base_url();?>admin/c_inbound_management/delete/', {
                "did": did,
                "startTime": startTime,
                "endTime": endTime,
                "hphm": hphm,
    ...
    $(".add").click(function () {
        layer.open({
            ...
            area: ['60%', '70%'],
            content: ['<?php echo base_url();?>admin/c_inbound_management/inbound_add/', 'yes']
        })
    });
    ...
    $(".edit").click(function () {
        ...
        layer.open({
            ...
            skin: 'layui-layer-lan',
            area: ['60%', '70%'],
            content: ['<?php echo base_url();?>admin/c_inbound_management/inbound_edit/' + id, 'yes']
        })
    });
</script>
</html>