...
<script>
    ...
    $(".add").click(function(){
        layer.open({
            ...
            area:['60%','70%'],
            content: ['<?php echo base_url();?>admin/c_the_month/add/', 'yes']
        })
    });
    //删除
    $(".delete") .click(function(){
        ...
        layer.confirm('确定删除该任务？', {
            ...
            $.post('<?php echo base_url();?>admin/c_the_month/delete/',{"id":id},function(data){
                if(data == '1')
                {
                    layer.msg("删除成功！",{
                        time:1.5*1000
                    },function(){
                        window.location.href = '<?php echo base_url()?>admin/c_the_month/index/';
                    });
                }else
                {
                    layer.msg("删除失败,请重试！");
    ...
    $(".edit").click(function(){
        ...
        layer.open({
            ...
            skin:'layui-layer-lan',
            area:['60%','70%'],
            content: ['<?php echo base_url();?>admin/c_the_month/edit/'+id, 'yes']
        })
    });
</script>
</body>