        ...
        <div class="tab-panel active" id="tab-set" style="">
            <form method="post" class="form-x" method="post" target="_parent">
                <div class="form-group">
                    ...
                    <input type="hidden" value="<?php echo $data2[0]['id'];?>" id="h_id">
                    <div class="field">
                        <input type="text" class="input"  value="<?php echo $data2[0]['hphm'];?>" id="hphm">
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                    ...
                    <div class="field">
                        <select id="hpzl" class="input">
                            ...
                            <?php foreach ($data1 as $row1) {?>
                                <option value="<?php echo $row1['DMZ'];?>" <?php if($row1['DMZ'] == $data2[0]['hpzl']){ echo "selected";}?>><?php echo $row1['DMSM1'];?></option>
                            <?php }?>
                        </select>
                    </div> 
                </div>
                    ...
                    <div class="field">
                        <select class="input" id="ywlx">
                            ...
                            <?php foreach ($datas as $row){?>
                                <option value="<?php echo $row['id'];?>" <?php if($row['id'] == $data2[0]['ywlx']){ echo "selected";}?>><?php echo $row['task_name'];?></option>
                            <?php }?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="field">
                        <table class="table table-bordered table-hover"style="width: 90%;">
                            ...
                            <?php foreach ($data as $value): ?>
                                <tr class="tr_class">
                                    <td><input class="assign_checkbox"  name="dldm[]" type="radio" <?php if($value['orgnum'] == $data2[0]['bmdm']) { echo "checked";}?> value="<?php echo $value['orgnum'].'+'.$value['orgname'];?>"></td>
...
<script type="text/javascript">
    ...
    $("#sub").click(function () {
        ...
        //提交保存
        $.ajax({
            url:URL+'admin/c_task_assignment/task_edit_pro',
            type:'post',
            data:{'id':id,'hphm':hphm,'hpzl':hpzl,'ywlx':ywlx,'str':str,'strs':strs},
