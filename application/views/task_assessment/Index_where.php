                    ...
                    <form method="post" action="<?php echo base_url()?>admin/c_task_assessment/search">
                        <div class="filed input-group">
                            <div class = "search2">
                                ...
                                <span>身份证码：</span><input type="text" id="sfzmhm" name="sfzmhm"  style="width: 200px" value="<?php echo $sfzmhms;?>"> &nbsp;&nbsp;
                                <br>
                                ...
                                <span>结束时间：</span><input autocomplete="off" type="text" id="endTime" name="endTime"  style="width: 200px" <?php if($endTime):?>  value="<?php echo date('Y-m-d H:i',$endTime);?>" <?php endif;?> > &nbsp;&nbsp;
