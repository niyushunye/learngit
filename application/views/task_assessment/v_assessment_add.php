        ...
        <div class="tab-panel active" id="tab-set" style="">
            ...
            <form method="post" class="form-x" method="post" target="_parent">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input"   value="" id="hpzl">
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                    ...
                    <div class="field">
                        <select class="input" id="ywlx">
                            ...
                            <?php foreach ($data1 as $row){ if($row != ""){?>
                                <option value="<?php echo $row['ywlx'];?>"><?php echo $row['task_name'];?></option>
                            <?php }?>
                            <?php }?>
                        </select>
                    </div>
                ...
                <div class="form-group" style="display: none;" id="wfcyy_div">
                    ...
                    <div class="field">
                        <textarea class="input" id="wfcyy" style="height: 100px;width:90%;min-width: 90%;max-width: 90%;min-height: 100px;"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input" id="czsj" name="czsj"  value="<?php echo date('Y-m').'-01 00:00:00';?>">
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                    ...
                    <div class="field">
                        <textarea id="czjg" class="input" style="height: 100px;width:90%;min-width: 90%;max-width: 90%;min-height: 100px;"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
...
<script type="text/javascript">
    ...
    $("#sub").click(function () {
        ...
        $.ajax({
            url:URL+'admin/c_task_assessment/assessment_save',
            type:'post',
            data:{
                'hphm': hphm,
                'hpzl': hpzl,
                ...
                success:function(data)
                {
                    ...
                    else
                    {
                        ...
                        for(var i=0;i<arr1.length;i++)
                        {
                            if(arr1[i] != "")
                            {
                                $("#img_div").html($("#img_div").html()+"<div style='width: 98px;float:left;height: 98px;'><img class='img_class' id='"+'assets/uploads/investigation_car_image/'+arr1[i] +"'"  +"  style='width: 80px;margin-top:5%;margin-left:5%;float:left;height: 80px;' src='"+URL+'assets/uploads/investigation_car_image/'+arr1[i]+"'><div class='delte_img' style='width:12px;cursor:pointer;float:right;border:1px solid white;height:12px;text-align:center;line-height:10px;color:white;background-color:red;font-weight:400;z-index: 100;border-radius: 50%;'>x️</div></div>");
                            }
                        }
                    }
                    //删除图片
