        ...
        <div class="">
            <div class="">
                <div style="margin-bottom: 20px">
                    <form action="<?php echo base_url();?>admin/c_vehicle/suosou" method="post">
...
<script>
    ...
    $('.details').click(function(){
        ...
        layer.open({
            ...
            area:['70%','75%'],
            content: ['<?php echo base_url();?>admin/c_vehicle/details/?id='+id, 'yes']
        })
    });
    ...
    $('.edit').click(function(){
        ...
        layer.open({
            ...
            skin:'layui-layer-lan',
            area:['40%','60%'],
            content: ['<?php echo base_url();?>admin/c_vehicle/edit/?id='+id, 'yes']
        })
    });
    ...
    $(".delete").click(function(){
        ...
        layer.confirm('你确定要删除该数据？', {
            ...
            $.post('<?php echo base_url();?>admin/c_vehicle/delete/',{"id":orgid},function(data){
                if(data == 1){

                    layer.msg("删除成功！",{
                        time:1.5*1000
                    },function(){
                        window.location.href = '<?php echo base_url()?>admin/c_vehicle/filelist/'+ this_orgnum;
                    });
                }else{
