        ...
        <div class="tab-panel active" id="tab-set" style="">
            <form method="post" class="form-x" method="post" target="_parent">
                <div class="form-group">
                    ...
                    <div class="field">
                        <textarea class="input" style="height: 100px;width:90%;max-width:90%;min-width:90%;border: 1px solid #e1e2ef;" id="work_completion"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                    ...
                    <div class="field">
                        <textarea class="input" style="height: 100px;width:90%;max-width:90%;min-width:90%;border: 1px solid #e1e2ef;" id="work_fault"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                    ...
                    <div class="field">
                        <textarea class="input" style="height: 100px;width:90%;max-width:90%;min-width:90%;border: 1px solid #e1e2ef;" id="learning_progress"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" autocomplete="off" class="input" id="inbound_time" name="log_time" value="">
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $("#sub").click(function () {
        ...
        //提交保存
        $.ajax({
            url:'<?php echo base_url()?>admin/c_job_log/task_save',
            type:'post',
            data:{
