                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <select class="input" id="score_month">
                            <option value="">---请选择---</option>
                            <option value="score_1">呜呜考核(15)</option>
                            <option value="score_2">业务工作(47分)</option>
                            <option value="score_3">支队吊销驾驶证(16分)</option>
                            <option value="score_4">四个一律(4分)</option>
                            <option value="score_5">坚持一月一法一考(15分)</option>
                            <option value="score_6">按时上报执法工作信息(3分)</option>
                        </select>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('#score').blur(function (){
        ...
        $.ajax({
            url:URL+'admin/c_legal_work/validation',
            type:'post',
            data:{
    ...
    $('#sub').click(function (){
        ...
        $.ajax({
            url:URL+'admin/c_legal_work/score_save',
            type:'post',
            data:{
                'score_company':score_company,
                'unit':unit,
