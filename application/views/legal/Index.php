    ...
    <div>
        <div>
            <div>
                ...
                <form action="<?php echo base_url()?>admin/c_legal/index" method="post">
                ...
                <form class="form-horizontal" name="" method="post" action="">
                    <div class="ibox-content">
                        <canvas id="line" height="230px" style="display:none;"></canvas>
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr class="bg-back">
                                    ...
                                    <th  style="vertical-align:middle" width="8%">五无考核</th>
                                    <th  style="vertical-align:middle" width="8%">业务工作</th>
                                    <th  style="vertical-align:middle" width="10%">支队吊销驾驶证</th>
                                    <th  style="vertical-align:middle" width="8%">四个一律</th>
                                    <th  style="vertical-align:middle" width="10%">坚持一月一法一考</th>
                                    <th  style="vertical-align:middle" width="20%">按时上报执法工作信息</th>
                                    <th  style="vertical-align:middle" width="13%">排名靠前加10分</th>
                                    <th rowspan="2" style="vertical-align:middle" width="5%">总分</th>
                                    <th rowspan="2" style="vertical-align:middle" width="5%">排名</th>
                                  <!--   <th rowspan="2" style="vertical-align:middle" width="5%">奖金分配(元)</th> -->
                                </tr>
                                <tr class="bg-back">
                                    <th >15分</th>
                                    <th >47分</th>
                            ...
                            <tr>
                               ...
                               <td colspan="3"  style="border:none;height: 100px;vertical-align:middle">部门负责人:&nbsp;<input type="text" name="bmfzr" id='bmfzr' value="<?php echo $assessor['BMFZR'];?>" style="width: 85px;text-align: center;border:none;"></td>
                               <td colspan="4"  style="border:none;height: 100px;vertical-align:middle">审核领导:&nbsp;<input type="text" name="shld" id='shld' value="<?php echo $assessor['SHLD'];?>" style="width: 85px;text-align: center;border:none;"></td>
                            </tr>
                        </table>
                    </div>
                </form>
                    ...
                    name.click(function () {   
                        ...
                        inputObj.blur(function () {   
                            ...
                            if(!reg.test(newText)){
                                ...
                                $.post("<?php echo base_url();?>admin/c_legal/set_bonus/",{"score_company":score_company,"bonus":newText},
                                function(data){
...
<script type="text/javascript">
  $('#hz,#bmfzr,#shld').blur(function(){
        ...
        $.ajax({
            'url': "<?php echo base_url();?>admin/c_legal/set_hz",
            'type':"post",
...
<script>
    ...
    $(".export").click(function(){   
        ...
        layer.confirm('是否导出该表？', {
            ...
            window.location.href = '<?php echo base_url();?>admin/c_legal/export?score_month='+score_month;
