...
class c_job_log extends CI_Controller{
    //危险道路统计
    //官方给的写法,构造函数
    ...
    public function index(){
        ...
        $config['per_page'] = 15;
        $config['base_url'] = base_url().'/admin/c_job_log/index/';
        $arr = $this -> m_job_log -> select_numbers_model();
        $data['total'] = $arr;
        $config['total_rows'] = $data['total'];
        $data['data'] = $this->m_job_log->select_task_assessmentinfo($config['per_page'],$offect);
