...
|--------------------------------------------------------------------------
|
| 这里是存放所有系统所需要的通用信息,比如:标题,名称等相关信息.
| 作者:andyzu
| 邮箱:andyzu@qingter.com
|
*/

$config['webtitle'] = '汉滨大队一网考系统';
$config['version'] = '1.0';
$config['keywords'] = '汉滨大队一网考系统';    //这里存放HTML里需要的keywords;
$config['description'] = '汉滨大队一网考系统'; //这里存放HTML里需要的description;
...
|
*/
$config['root_path'] = $_SERVER['DOCUMENT_ROOT']."/ak_system/";
...
|
*/
//$config['base_url'] = 'http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/ak_system';
//$config['base_url'] = 'http://'.$_SERVER['SERVER_NAME'].'/ak_system';
$config['base_url'] = 'http://192.168.1.38/ak_system';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
